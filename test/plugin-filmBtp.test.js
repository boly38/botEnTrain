...
const logger = log4js.getLogger('filmBTP.test');
...
describe("filmBTP", function() {

  before(async () => {
    logger.debug("filmBTP test :: before");
    plugin = appConfig.get('filmBTP');
  });

  it("simulate film btp", async () => {
